    ...
    return (
        <header className="header">
            <div className="header-frame">
                <button className="logo-button">TripMaven</button>
                <div className="nav-frame">
                    <div className="nav-items">
                        <button className="nav-button home-button">Home</button>
                        <menu className="dropdown-menu">
                            <div className="dropdown-text">마이 페이지</div>
                            <svg
                        ...
                        <button className="nav-button">가이드 등록</button>
                        <button className="nav-button">회원가입</button>
                    </div>
                    <button className="login-button">
                        <div className="login-text" onClick={()=>navigate('/login')}>로그인</div>
                    </button>
                </div>
            </div>
        </header>
