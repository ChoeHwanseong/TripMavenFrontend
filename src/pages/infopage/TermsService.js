    ...
    <div className={styles.container}>
      ...
      <div className={styles.section}>
        ...
        <ul>
          ...
          <li>트립메이븐이 어떤 정보를 수집하고, 수집한 정보를 어떻게 사용하며, 필요에 따라 누구와 이를 공유('위탁 또는 제공')하며, 이용 목적을 달성한 정보를 언제 어떻게 파기하는지 등 정보를 투명하게 제공합니다</li>
        ...
        <p style={{fontWeight:'bold',marginLeft:'38px'}}>
          회원가입 시점에 트립메이븐이 이용자로부터 수집하는 개인정보는 아래와 같습니다
        </p>
        <ul>
          <li>회원 가입 시 필수 항목으로 이메일,이름,비밀번호,휴대전화번호를 수집합니다.</li>
          <li>필수항목이 아닌 경우 마이프로필에서 입력 및 수정이 가능합니다</li>
          <p style={{fontWeight:'bold'}}>
            서비스 이용 과정에서 이용자로부터 수집하는 개인정보는 아래와 같습니다.
          </p>
          <li>회원정보 또는 개별 서비스에서 프로필 정보(닉네임,프로필 사진)을 설정할 수 있습니다.</li>
          <p style={{fontWeight:'bold'}}>
            트립메이븐은 아래의 방법을 통해 개인정보를 수집합니다
          </p>
          <li>회원가입 및 서비스 이용 과정에서 이용자가 개인정보 수집에 대헤 동의를 하고 직접 정보를 입력하는 경우,해당 개인정보를 수집합니다.</li>
          <li>고객센터를 통한 상담 과정에서 메일,전화 등을 통해 이용자의 개인 정보가 수집될 수 있습니다.</li>
        </ul>
      </div>
      ...
      <div className={styles.section}>
        ...
        <ul>
          ...
          <li>회원 가입 의사의 확인, 이용자 식별, 회원탈퇴 의사의 확인 등 회원 관리를 위하여 개인정보를 이용합니다.</li>
        </ul>
      </div>
      ...
      <div className={styles.section}>
        ...
        <ul>
          <li>단, 이용자에게 개인정보 보관기간에 대해 별도의 동의를 얻은 경우, 또는 법령에서 일정 기간 정보보관 의무를 부과하는 경우에는 해당 기간 동안 개인정보를 안전하게 보관합니다.</li>
        </ul>
      </div>
    </div>
  );
