      ...
      <div className={styles.section}>
        ...
        <form className={styles.form}>
          <div className={styles.formGroup}>
            <input type="password" className={styles.input} ref={passwordRef} placeholder="새 비밀번호" />
            {error.passwordError && <p className={styles.error}>{error.passwordError}</p>}
          </div>
          <div className={styles.formGroup}>
            <input type="password" className={styles.input} ref={passwordconfirmRef} placeholder="새 비밀번호 확인" onKeyDown={handleEnterPress} />
