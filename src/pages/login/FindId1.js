  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.section}>
        ...
        <form className={styles.form}>
          ...
          <div className={styles.formGroup}>
            ...
            <button type="button" className={styles.verifyButton}>인증번호 받기</button>
          </div>
      ...
      <div className={styles.section}>
        ...
        <p className={styles.description}>
          회원정보에 등록한 이메일 주소와 이메일 주소가 같아야, 인증번호를 받을 수 있습니다.
        </p>
        <form className={styles.form}>
          <div className={styles.formGroup}>
            <label className={styles.label}>이름</label>
          ...
          <div className={styles.formGroup}>
            ...
            <input type="text" className={styles.input} placeholder="이메일주소를 입력하세요" />
          </div>
          <div className={styles.formGroup}>
            <input type="text" className={styles.input} placeholder="인증번호 6자리 숫자 입력" />
            <button type="button" className={styles.verifyButton}>인증번호 받기</button>
